...
class QueryCartDetailsManageAdapter(
    private val context: Context,
    private var cartList: ArrayList<CartDetails>
) :
    RecyclerView.Adapter<QueryCartDetailsManageAdapter.ViewHolder>() {
    inner class ViewHolder(view: View) : RecyclerView.ViewHolder(view) {
        ...
        val cartUserName :TextView  = view.findViewById(R.id.tv_shoppingCart_userName)
    }
    ...
    override fun onCreateViewHolder(
        ...
        val view = LayoutInflater.from(context)
            .inflate(R.layout.recycler_manage_query_cart_item, parent, false)
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.cartUserName.text = cartDetails.userName
