...
public class OssManager {
    ...
    private OnDeleteStateListener onDeleteStateListener;
    /**
     * OSS async task
     */
    ...
    public void setOnDeleteStateListener(OnDeleteStateListener listener) {
        this.onDeleteStateListener = listener;
    }
        ...
        mOSSAsyncTask = oss.asyncGetObject(get, new OSSCompletedCallback<GetObjectRequest, GetObjectResult>() {
            ...
            public void onSuccess(GetObjectRequest request, GetObjectResult result) {
                ...
                try {
                    ...
                    downImageBitmap = BitmapFactory.decodeFile(file.getAbsolutePath());
        ...
        mOSSAsyncTask = oss.asyncDeleteObject(delete, new OSSCompletedCallback<DeleteObjectRequest, DeleteObjectResult>() {
            ...
            public void onSuccess(DeleteObjectRequest request, DeleteObjectResult result) {
                ...
                if (onDeleteStateListener != null) {
                    onDeleteStateListener.onSuccess(request, result);
                }
            }
            ...
            public void onFailure(DeleteObjectRequest request, ClientException clientException, ServiceException serviceException) {
                ...
                if (onDeleteStateListener != null) {
                    onDeleteStateListener.onFailure(request, clientException, serviceException);
                }
            }
        });
    }
    ...
    public interface OnDeleteStateListener {
        void onSuccess(DeleteObjectRequest request, DeleteObjectResult result);

        void onFailure(DeleteObjectRequest  request, ClientException clientException, ServiceException serviceException);
    }
